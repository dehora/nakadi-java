...
public class StreamOffsetObserverPublisher implements StreamOffsetObserver {
  ...
  private StreamOffsetObserverPublisher() {
  ...
  static StreamOffsetObserverPublisher create() {
    return new StreamOffsetObserverPublisher();
  }

  StreamOffsetObserverPublisher subscribe(StreamOffsetObserver streamOffsetObserver) {
